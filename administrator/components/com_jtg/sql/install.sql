...
('COM_JTG_MAP_OSM_HIKE_AND_BIKE', 2, 1, 'OpenLayers.Layer.XYZ("{name}", "https://a.tiles.wmflabs.org/hikebike/${z}/${x}/${y}.png",{displayOutsideMaxExtent: true, isBaseLayer: true, attribution: "Map Data © <a href=http://www.openstreetmap.org/copyright>OpenStreetMap</a> contributors", transitionEffect: "resize" })', '', ''),
('COM_JTG_MAP_CYCLEMAP', 3, 1, 'OpenLayers.Layer.OSM.CycleMap("{name}")', '', ''),
('COM_JTG_MAP_GOOGLE_SAT', 5, 1, 'OpenLayers.Layer.Google( "{name}", {type: google.maps.MapTypeId.SATELLITE, numZoomLevels: 22})', 'https://maps.google.com/maps/api/js?v=3&amp;sensor=false', ''),
('COM_JTG_MAP_GOOGLE_STREET', 6, 1, 'OpenLayers.Layer.Google( "{name}",  {numZoomLevels: 20})', 'https://maps.google.com/maps/api/js?v=3&amp;sensor=false', ''),
('COM_JTG_MAP_GOOGLE_HYBRID', 7, 1, 'OpenLayers.Layer.Google( "{name}",  {type: google.maps.MapTypeId.HYBRID, numZoomLevels: 20})', 'https://maps.google.com/maps/api/js?v=3&amp;sensor=false', ''),
('COM_JTG_MAP_GOOGLE_PHYSICAL', 8, 1, 'OpenLayers.Layer.Google("{name}", {type: google.maps.MapTypeId.TERRAIN} )', 'https://maps.google.com/maps/api/js?v=3&amp;sensor=false', ''),
...
('COM_JTG_MAP_FRENCH_IGN_GEOPORTAL', 12, 1, 'OpenLayers.Layer.WMTS({ 		name: "{name}", 		url: "https://gpp3-wxs.ign.fr/"+ ign_api_key + "/wmts", 		layer: "GEOGRAPHICALGRIDSYSTEMS.MAPS", 		matrixSet: "PM",         projection: new OpenLayers.Projection("EPSG:900913"),         units: "m", 		theme: null, 		style: "normal", 		numZoomLevels: 19, 		attribution: "Map base: ©IGN  Terms of Service" 	})', '', 'var ign_api_key = &quot;10gwaoqj0yqvlfi94vw12rns&quot;;'),
('COM_JTG_MAP_HIKE_AND_BIKE_HILLSHADE', 13, 1, 'OpenLayers.Layer.XYZ("{name}", "https://a.tiles.wmflabs.org/hillshading/${z}/${x}/${y}.png",{displayOutsideMaxExtent: true, isBaseLayer: false, visibility: false, attribution: "Hillshading: SRTM3 v2 (<a href=https://www2.jpl.nasa.gov/srtm/>NASA</a>)" , transitionEffect: "resize" })', '', '');
...
(1, 430, '19', '-sample- Woodhead Reconnaissance', 'sample_woodhead_reconnaissance.gpx', '2', '<p>This tracks by has been provided by Richard from RSInfotech <a href="https://www.rsinfotech.co.uk/">https://www.rsinfotech.co.uk/</a></p>\r\n<p><em>It its only intended to be used as a sample file for testing and demonstrating J!Track Gallery component.</em></p>', 1, '2013-09-22', 52, 0, '53.4947858175', '-1.8294689814', 5.94, 357, 284, 1, 0, 1, 0, 0, NULL, 4.000, 0),
(2, 430, '15', '-sample- Circuit de Bavay', 'sample_bavay.gpx', '2', '<p>This tracks by has been provided by Arnaud  from the French Alpin Club:  Club Alpin de Lille <a href="https://clubalpinlille.fr/">https://clubalpinlille.fr/</a></p>\r\n<p><em>It its only intended to be used as a sample file for testing and demonstrating J!Track Gallery component.</em></p>', 1, '2013-09-23', 27, 0, '50.297820', '3.792730', 21.92, 254, 254, 1, 0, 1, 0, 0, 0, 2.667, 0),
(3, 430, '15', '-sample- Circuit Honnelles-Belgique', 'sample_honnelles_belgique.gpx', '2', '<p>This tracks by has been provided by Arnaud  from the French Alpin Club:  Club Alpin de Lille <a href=&#34;https://clubalpinlille.fr/&#34;>https://clubalpinlille.fr/</a></p>\r\n<p><em>It its only intended to be used as a sample file for testing and demonstrating J!Track Gallery component.</em></p>', 1, '2013-09-23', 20, 0, '50.364941', '3.775907', 21.29, 256, 256, 1, 0, 1, 0, 0, 0, 4.000, 0),
(4, 430, '15', '-sample- Circuit Vandegie sur Ecaillon', 'sample_vandegie_sur_ecaillon.gpx', '2', '<p>This tracks by has been provided by Arnaud  from the French Alpin Club:  Club Alpin de Lille <a href=&#34;https://clubalpinlille.fr/&#34;>https://clubalpinlille.fr/</a></p>\r\n<p><em>It its only intended to be used as a sample file for testing and demonstrating J!Track Gallery component.</em></p>', 1, '2013-09-23', 99, 0, '50.262709', '3.511753', 26.79, 829, 799, 2, 0, 1, 0, 0, 0, 6.500, 0),
...
(13, 430, '12', '-sample- Trek Valroc Secteur 3', 'sample_trek_valroc_3.gpx', '2', '<p>This tracks by has been provided by Pascal from the French Alpin Club:  club alpin français de l''ouest dijonnais <a href="https://valroc.net">https://valroc.net</a></p>\r\n<p><em>It its only intended to be used as a sample file for testing and demonstrating J!Track Gallery component.</em></p>', 1, '2013-10-03', 14, 0, '47.510856846', '4.529040931', 34.99, 915, 844, 3, 0, 1, 0, 0, NULL, 0.000, 0),
(12, 430, '12', '-sample- Trek Valroc Secteur 2', 'sample_trek_valroc_2.gpx', '2', '<p>This tracks by has been provided by Pascal from the French Alpin Club:  club alpin français de l''ouest dijonnais <a href=&#34;https://valroc.net&#34;>https://valroc.net</a></p>\r\n<p><em>It its only intended to be used as a sample file for testing and demonstrating J!Track Gallery component.</em></p>', 1, '2013-10-03', 10, 0, '47.318670190', '4.598339923', 49.88, 1256, 1235, 1, 0, 1, 0, 0, NULL, 0.000, 0),
(11, 430, '12', '-sample- Trek Valroc Secteur 1', 'sample_trek_valroc_1.gpx', '2', '<p>This tracks by has been provided by Pascal from the French Alpin Club:  club alpin français de l''ouest dijonnais <a href=&#34;https://valroc.net&#34;>https://valroc.net</a></p>\r\n<p><em>It its only intended to be used as a sample file for testing and demonstrating J!Track Gallery component.</em></p>', 1, '2013-10-08', 1, 0, '47.323145801', '5.028378814', 53.79, 2017, 1890, 1, 0, 1, 0, 0, NULL, 0.000, 0),
